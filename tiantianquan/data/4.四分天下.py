...
def process_single_image(img_path: str, label_path: str, output_images_dir: str, output_labels_dir: str, area_size: int):
    """处理单张图片：裁剪4个子图 + 生成对应YOLO标签（无标签则不生成标签文件）"""
    # 1. 读取图片和基本信息
...
if __name__ == '__main__':
    # ====================== 只需配置以下参数 ======================
    INPUT_DATASET_ROOT = r"E:\workspace-pycharm\ttq_dataset\data\test"  # 输入数据集根目录
    OUTPUT_DATASET_ROOT = r"E:\workspace-pycharm\ttq_dataset\data\test_after"  # 输出根目录
    CROP_AREA_SIZE = 300  # 裁剪偏移尺寸（像素）
    # ============================================================
