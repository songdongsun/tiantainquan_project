...
# model = YOLO("path/to/best_seg.pt")  # Load a custom trained model
...
# yolo track model=path/to/best_seg.pt source="https://youtu.be/LNwODJXcvt4" # Custom trained model

# Track using ByteTrack tracker
# yolo track model=path/to/best_seg.pt tracker="bytetrack.yaml"
```
